					                  ...
					                  <div class="modal-body">
					                    ...
					                    <div class="form-group">
					                      ...
					                      <select class="form-control" name="type" required>
					                        ...
					                        <option value="mp">Military Post</option>
					                  ...
					                  <div class="modal-body">
					                    ...
					                    <div class="row">
					                      <div class="col-md-6">
					                        <div class="form-group">
					                          <label>Password</label>
					                          <input type="text" class="form-control " name="password" required value="<?php echo $row['password']?>">
					                        </div>
					                      </div>
					                      <div class="col-md-6">
					                        <div class="form-group">
					                          <label>Re - Password</label>
					                          <input type="text" class="form-control " name="repassword" required value="<?php echo $row['password']?>">
					                        </div>
					                      </div>
					                    </div>
					                    ...
					                    <div class="form-group">
					                      ...
					                      <select class="form-control" name="type" required>
					                        ...
					                        <option <?php if($row['type'] == 'mp'){ echo 'selected';}?> value="mp">Military Post</option>
