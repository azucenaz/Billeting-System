...
$fetch = $dbConn->query("SELECT * FROM tbl_transactions_am where id = '".$_GET['id']."' ");
$row = $fetch->fetch(PDO::FETCH_ASSOC);

$guest = $dbConn->query("SELECT * FROM tbl_guests where guest_id = '".$row['guest_id']."' ");
$display = $guest->fetch(PDO::FETCH_ASSOC);

$ro = $dbConn->query("SELECT * FROM tbl_ameneties where ameneties_id = '".$row['room_id']."' ");
	...
	<tr>
		<td height="100px">
			<table width="600px" align="center">
				...
				<tr>
					<td align="right"><label><b>Amenety Name:</b></label></td>
					<td align="center"><?php echo $room['ameneties_name']?></td>
				</tr>
				<tr>
