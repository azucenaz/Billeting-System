...
<button id="minimizeSidebar" class="btn btn-fill btn-icon"><i class="fa fa-chevron-left"></i></button>
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> Base Ameneties</a>
                </div>
                <?php
            ...
            <div class="card">
                <div class="content text-center">
                    ...
                    <div class="col-lg-12" style="padding-bottom:10px;">
                        <?php if($_SESSION['type'] == 'admin'){ ?>
                        <button class="btn btn-info" data-target="#<?php echo $row['ameneties_id']; ?>" data-toggle="modal">EDIT</button>
                        <a class="btn btn-success" href="viewreserve_am.php?id=<?php echo $row['ameneties_id']?>" target="_blank">VIEW</a>
                    <?php }else{  ?> 
                        <button class="btn btn-info" data-target="#view_details<?php echo $row['ameneties_id']?>" data-toggle="modal">VIEW</button>
                  <?php }; ?>  
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="view_details<?php echo $row['ameneties_id']?>">
                                <div class="modal-dialog " style="padding-top:60px;">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        Facility Name: <?php echo $row['ameneties_name'];?><br>
 ...
 <div class="modal fade" id="<?php echo $row['ameneties_id']; ?>" style="margin-top:100px;">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <form method="post" action="execute/updateamenety.php">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h5 class="modal-title" id="myModalLabel" align="center">Update Amenety</h5>
                                            </div>

                                            <div class="modal-body">
                                            <div class="row">

                                                <input type="hidden" value="<?php echo $row['ameneties_id'];?>" name="id">
                                            ...
                                            <div class="col-md-8 col-md-offset-2">
                                                <label>Name</label>
                                                    <input type="text" placeholder="" class="form-control" name="name" required value="<?php echo $row['ameneties_name'];?>">
                                            </div>

                                            <div class="col-md-8 col-md-offset-2">
                                                <label>Description</label>
                                                    <textarea class="form-control" placeholder="" rows="3" name="description" required><?php echo $row['ameneties_description'];?></textarea>
                                            </div>


                                                     <div class="col-md-8 col-md-offset-2">
                                                <label>Price</label>
                                                    <input type="number" min="0" step="0.01" placeholder="" class="form-control" name="price" required value="<?php echo $row['ameneties_price'];?>">
                                            </div>                                            
