	    ...
	    <div class="main-panel">
			<nav class="navbar navbar-default">
	            <div class="container-fluid">
	                ...
	                <div class="navbar-header">
						...
						<?php 
												...
												$getroom = $dbConn->query("SELECT * FROM tbl_ameneties where ameneties_id = '".$_GET['id']."' ");
	            ...
	            <div class="container-fluid">
	            	...
	            	<button onclick="printContent('occupants')" class="btn btn-info">AMENETIES REPORT</button>
				    <br>
				    <br>
	                    ...
	                    <div class="col-md-12">
	                        ...
	                        <div class="card">
	                            <div class="content">
									...
									<div align="center">
										<h3><b><?php echo $disroom['ameneties_name']; ?></b></h3>
									</div>
										...
										<tbody>
											...
											<?php
											$users = $dbConn->query("SELECT * FROM tbl_reservations where room_id = '".$_GET['id']."' AND status = 'PAID' ");
											...
											<tr data-toggle="modal" data-target="#">
												...
												<td>
													...
													<label font-styele="bold"> <?php echo $row['datefrom']?> - <?php echo $row['dateto'] ?> </label>
