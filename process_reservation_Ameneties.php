...
$_SESSION['active'] = 'process_reservation_Ameneties';
					              ...
					              <div class="modal-content">
					                <form method="post" action="execute/payment.php">
					                  ...
					                  <div class="modal-body">
					                  	...
					                  	<!-- data values  -->
<!-- 					                   	<input type="hidden" value="<?php echo isset($_SESSION['facility_id']) ? $_SESSION['facility_id']: '' ?>" name="facility_id">
					                      ...
					                      <div class="col-md-6 ">
					                        <div class="form-group">
					                          <label>Reservation Date</label>
					                          	<p><?php echo isset($_SESSION['from']) ? $_SESSION['from']: '' ?> TO  <?php echo isset($_SESSION['to']) ? $_SESSION['to']: '' ?></p>
					                        </div>
					                      ...
					                      <div class="col-md-6 ">
					                        <div class="form-group">
					                          <label>Facility Name</label>
					                           <p><?php echo isset($_SESSION['room_name']) ? $_SESSION['room_name']: '' ?></p>
					                        </div>
					                      </div>
					                      ...
					                      <div class="col-md-6">
					                        <div class="form-group">
					                          <label>Amount to Pay</label>
					                    		<p><?php echo isset($_SESSION['payment']) ? number_format($_SESSION['payment'],2): '0.00' ?></p>      
					                        </div>
					                      </div>
	            		...
	            		<div class="card" id="card" style="z-index:5;">
	            			<div class="content clearfix">
	            				...
	            				<div class="col-md-offset-4 col-md-4">
	            					...
	            					<a class="btn btn-block btn-danger" style="cursor:none;" name="submit" id="hidethis">PLEASE SELECT FIRST FACILITY</a>
	            				</div>
	            				</form>
	            			</div>
	            		</div>
